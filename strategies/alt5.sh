#!/bin/sh
# ═══════════════════════════════════════════════════════
# Proboy Strategy: ALT 5
# Source: Flowseal ALT 5
# ═══════════════════════════════════════════════════════

NFWQS="${INSTALL_DIR}/bin/nfqws"

NFQWS_OPT="
--filter-tcp=443 --dpi-desync=fake,split2 --dpi-desync-split-seqovl=1 --dpi-desync-split-pos=1,midsld --dpi-desync-fooling=badseq --dpi-desync-autottl=2 --new
