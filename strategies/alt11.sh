#!/bin/sh
# ═══════════════════════════════════════════════════════
# Proboy Strategy: ALT 11
# Source: Flowseal ALT 11
# ═══════════════════════════════════════════════════════

NFWQS="${INSTALL_DIR}/bin/nfqws"

NFQWS_OPT="
--filter-tcp=443 --dpi-desync=fake,splithttp --dpi-desync-split-pos=1 --dpi-desync-fooling=badseq --dpi-desync-autottl=2 --dpi-desync-repeats=4 --new
